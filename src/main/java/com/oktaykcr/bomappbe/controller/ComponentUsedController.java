...
public class ComponentUsedController {
    ...
    public ListResponse<ComponentUsed> list(@RequestParam(value = "pageNumber") Integer pageNumber,
        ...
        return componentUsedService.listPaginated(pageNumber, pageOffset);
    }

    @GetMapping(value = "/all")
    public ListResponse<ComponentUsed> listAll(@RequestParam("bomId") String bomId) {
        return componentUsedService.listAllByBomId(bomId);
    }
